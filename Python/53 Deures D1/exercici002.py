...
pygame.display.set_caption('Alejandro López - Exercici 2')
...
def app_draw():
    ...
    draw_text("Pera", fontArial, 100, 100, "center", "mid")
    ...
    draw_text("Préssec", fontArial, 250, 100, "center", "mid")

    pygame.draw.circle(screen, BLUE, (250, 150), 5)
    draw_text("Meduixa", fontArial, 250, 150, "right", "bottom")
