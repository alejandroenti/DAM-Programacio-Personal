...
import sys
import random
from D_DausLlistes import afegir_jugador, escollir_jugador, mostrar_puntuacions, jugar, mainRun
...
class TestAfegirJugador(unittest.TestCase):
    ...
    def test_afegir_nou_jugador(self):
        ...
        self.assertEqual(len(nou_ranking), 3)
    ...
    def test_actualitzar_jugador_si_mes_alt(self):
        ...
        self.assertEqual(len(nou_ranking), 2)
